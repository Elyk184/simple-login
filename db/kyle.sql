...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2024 at 02:02 AM
...
(5, 'Marinel', 'Sabanal', 'mane', 'laoiauyshtra'),
(6, 'Nona Manuel', 'Rasonabe', 'mori', 'aefgjfktrh'),
(7, 'Efraim', 'Pacana', 'madam', 'hewqr0y'),
(12, 'jhasen', 'opaw', 'yayks', '55555');
...
(1, '1001', 'book', 'goods for study', 150.00, 100.00, 1),
(2, '1002', 'ballpen', 'goods for writing', 11.50, 12.00, 1),
(3, '1003', 'Nature Spring', 'For dehydration', 20.00, 20.00, 1);
